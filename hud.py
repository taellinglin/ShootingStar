...
class HUD:
    def __init__(self, game, bottle_manager):
        ...
        # Load custom font
        self.font = self.game.loader.loadFont('west.ttf')  # FIXED!
    ...
    def create_text(self, text, pos):
        return OnscreenText(
            text=text, pos=pos, scale=0.07, fg=(1, 1, 1, 1), 
...
class HUD:
    def __init__(self, game, bottle_manager):
        ...
        # Load custom font
        self.font = loader.loadFont("./west.ttf")  # FIXED!
...
class HUD:
    def __init__(self, game, bottle_manager):
        ...
        # Load custom font
        self.font = base.loader.loadFont('west.ttf')  # FIXED!
